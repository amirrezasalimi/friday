...
__export(src_exports, {
  FridayNodeJs: () => friday_nodejs_default
});
...
function removeDirectory(directory) {
  if (import_fs.default.existsSync(directory)) {
    import_fs.default.readdirSync(directory).forEach((file) => {
...
// src/friday-nodejs.js
var import_fs2 = __toESM(require("fs"));
var FridayNodeJs = class {
  aiConfig;
  data = {
    base_code: "",
    codes: [],
  ...
  async *generate({
    ...
    const aiChat = new ai_chat_default();
    try {
      yield this.res({
...
`
      ...
      const runtimeMs = endTime[0] * 1e3 + endTime[1] / 1e6;
      yield this.res({
        title: `Done`,
        step: 4,
        done: true,
...
:${e2.message}`,
  ...
  async createProject(projecDir, data) {
    try {
      if (import_fs2.default.existsSync(projecDir)) {
        removeDirectory(projecDir);
      }
      if (!import_fs2.default.existsSync(projecDir)) {
        import_fs2.default.mkdirSync(projecDir);
      }
      ...
      import_fs2.default.writeFileSync("package.json", JSON.stringify(packageJson, null, 2));
...
${data.base_code}`;
      ...
      import_fs2.default.writeFileSync("index.js", mergedContent);
      import_fs2.default.writeFileSync(".env", data.env.trim());
...
var friday_nodejs_default = FridayNodeJs;
